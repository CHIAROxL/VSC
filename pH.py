def main():
    ...
    def pH_tampone_basico(concentrazione_acido, concentrazione_base, Kb):
        pH = 14 -math.log10(Kb) - math.log10(concentrazione_base/concentrazione_acido)
    ...
    if scelta in scelta_1:
        ...
        numero_titolanti = int(input("quanti volumi di titolante vuoi inserire? "))
                ...
                if potenza_titolante == "forte":
                    ...
                    for i in range(numero_titolanti):
                        ...
                        if moli_analita_residue > 0:
                            ...
                            pH_acido_forte(concentrazione_analita)
                            print("il pH con " + str(volumi_titolante[i]) + "L di titolante è " + str(pH))

                        elif moli_analita_residue < 0:
                            concentrazione_titolante = -moli_analita_residue/(volume_analita + volumi_titolante[i])
                            pH_base_forte(concentrazione_titolante)
                            print("il pH con " + str(volumi_titolante[i]) + "L di titolante è " + str(pH))
                    ...
                    Kb = input("quanto vale la Kb1 (es. 1.8e-5)? ")
                    Ka = 10e-14/Kb
                    ...
                    for i in range(numero_titolanti):
                        ...
                        if moli_analita_residue > 0:
                            ...
                            concentrazione_idronio = concentrazione_analita + c_idronio_ac(concentrazione_sale_acido, Ka)
                            ...
                            pH = pH_tampone_basico(concentrazione_sale_acido, concentrazione_titolante, Kb)
                            print("il pH con " + str(volumi_titolante[i]) + "L di titolante è " + str(pH))

                        else:
                            concentrazione_sale_acido = moli_analita/(volume_analita + volumi_titolante[i])
                            pH_acido_debole(concentrazione_sale_acido, Ka)
                            print("il pH con " + str(volumi_titolante[i]) + "L di titolante è " + str(pH))
                ...
                if potenza_titolante == "forte":
                    ...
                    for i in range(numero_titolanti):
                        ...
                        if moli_analita_residue > 0:
                            ...
                            pH = pH_tampone_basico(concentrazione_acido, concentrazione_sale_basico, Kb)
                            print("il pH con " + str(volumi_titolante[i]) + "L di titolante è " + str(pH))
                        ...
                        if moli_analita_residue < 0:
                            ...
                            concentrazione_idrossido = concentrazione_base + c_idrossido_bc(concentrazione_sale_basico, Kb)
